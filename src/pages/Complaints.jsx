...
export default function Complaints() {
  ...
  const [form, setForm] = useState({ type: 'Complaint', category: 'Facilities', title: '', description: '', is_anonymous: false, photo: null });
  ...
  async function submit() {
    if (!form.title || !form.description) { toast.error('Fill in all required fields'); return; }
    const payload = {
      ...form,
        ...
        <DialogContent>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1">
              ...
              <Input type="file" onChange={handleFileChange} className="text-sm" accept=".jpg,.jpeg,.png,.webp,.pdf,.doc,.docx" />
            </div>
        ...
        <Dialog open={!!viewing} onOpenChange={() => setViewing(null)}>
          <DialogContent className="max-w-lg">
            ...
            <div className="space-y-3 text-sm">
              ...
              {viewing.photo && <img src={viewing.photo} alt="Attachment" className="max-w-full rounded-md mt-2" />}
