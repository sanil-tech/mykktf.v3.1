...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    async function load() {
      ...
      setStats({ totalResidents: activeStudents.length, availableRooms, occupiedRooms: rooms.length - availableRooms, pendingMaint, pendingLeave, pendingParcels, activeDiscipline, occupancyRate, blockDist, maintByCategory, leaveByStatus });
      setLoading(false);
    }
    load();
  }, []);
