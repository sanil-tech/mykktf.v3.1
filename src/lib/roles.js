...
export function getNavItems(role, hasJakmas = false) {
  const all = [
    ...
    { label: 'Drop-Key Check-Out', path: '/drop-key', icon: 'KeyRound', roles: [ROLES.SUPER_ADMIN, ROLES.PRINCIPAL, ROLES.ADMIN, ROLES.WARDEN, ROLES.STAFF, ROLES.JAKMAS, ROLES.STUDENT] },
